    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="pt-32 md:pt-48 pb-12 md:pb-20 px-6 md:px-8 grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-4 md:col-start-9 flex flex-col justify-end">
          <p className="font-sans text-base md:text-lg text-muted-foreground leading-relaxed">
            As a young studio, we believe the most extraordinary spaces emerge from genuine collaboration — with clients, craftspeople, engineers, and fellow creatives.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 md:px-8 py-20 md:py-32 grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-6">
        ...
        <div className="md:col-span-4 md:col-start-8">
          <span className="font-sans text-xs tracking-widest uppercase text-muted-foreground block mb-8">Our Process</span>
          <div className="space-y-10">
            <div className="space-y-3">
              <div className="flex items-baseline gap-4">
                <span className="font-serif text-3xl text-muted-foreground">01</span>
                <h3 className="font-sans text-sm font-medium tracking-widest uppercase">Listen</h3>
              </div>
              <p className="font-serif text-lg italic text-muted-foreground leading-relaxed pl-12">
                We begin every engagement with extended conversation. Understanding precedes design.
              </p>
            </div>
            <div className="space-y-3">
              <div className="flex items-baseline gap-4">
                <span className="font-serif text-3xl text-muted-foreground">02</span>
                <h3 className="font-sans text-sm font-medium tracking-widest uppercase">Shape</h3>
              </div>
              <p className="font-serif text-lg italic text-muted-foreground leading-relaxed pl-12">
                Iterative design through physical models, material studies, and site-specific research.
              </p>
            </div>
            <div className="space-y-3">
              <div className="flex items-baseline gap-4">
                <span className="font-serif text-3xl text-muted-foreground">03</span>
                <h3 className="font-sans text-sm font-medium tracking-widest uppercase">Realize</h3>
              </div>
              <p className="font-serif text-lg italic text-muted-foreground leading-relaxed pl-12">
                Meticulous execution with trusted craftspeople. We stay involved through the final detail.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-6 md:px-8 py-20 md:py-32 bg-secondary text-center">
        ...
        <a
          href="mailto:studio@mantle-atelier.com"
